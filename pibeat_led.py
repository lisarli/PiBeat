...
def display_button(button, button_rect, x, y):
   button_rect.x = x
   button_rect.y = y
   lcd.blit(button, button_rect)


def display_menu0():
   display_touch_buttons(menu0)
   display_button(get_started_button,get_started_rect,60,120)
  
def display_menu1():
   display_touch_buttons(menu1)
   display_button(ice_button,ice_button_rect,20,140)
   display_button(ocean_button,ocean_button_rect,160,60)
   display_button(rain_button,rain_button_rect,20,60)
   display_button(sky_button,sky_button_rect,190,140)


def display_menu2():
   reset_game()
   display_touch_buttons(menu2)
   display_button(start_button,start_button_rect,80,80)
   display_button(trophy_button,trophy_button_rect,10,190)


def display_menu3():
   global cur_score
   display_touch_buttons(menu3)
   display_button(pause_button,pause_button_rect,80,80)
   display_button(arrow_button,arrow_button_rect,10,190)
...
def display_menu4():
   ...
   display_button(resume_button,resume_button_rect,80,80)
   display_button(arrow_button,arrow_button_rect,10,190)
...
def display_menu5():
   ...
   # show team names
   display_button(ice_button,ice_button_rect,20,130)
   display_button(ocean_button,ocean_button_rect,160,60)
   display_button(rain_button,rain_button_rect,20,60)
   display_button(sky_button,sky_button_rect,190,130)
